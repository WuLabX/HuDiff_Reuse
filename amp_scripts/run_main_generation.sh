...
SAMPLE=amp_scripts/amp_sample.py

DE_FASTA=data/test/ampdiff_test_de.fasta
INP_FASTA=data/test/ampdiff_test_inp.fasta

PRETRAIN_CKPT=checkpoints/pretrain/stage2_motif.pt
DE_CKPT=checkpoints/de/de.pt
INP_CKPT=checkpoints/inp/inp.pt

DE_OUT=evaluation/ampdiff_test_de
INP_OUT=evaluation/ampdiff_test_inp
WORK=evaluation/_generation_runs
