...
def main():
    ...
    parser.add_argument("--input",   default="data/Generalizability/pretrain/AMP_51345.csv")
    parser.add_argument("--output",  default="data/Generalizability/pretrain/AMP_51345_clean.csv")
