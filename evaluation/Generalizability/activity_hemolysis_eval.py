...
def main() -> None:
    ...
    parser.add_argument("--pepnet-root", default=os.environ.get("PEPNET_ROOT", "external/PepNet"))
    parser.add_argument("--hemopi2-root", default=os.environ.get("HEMOPI2_ROOT", "external/hemopi2"))
    parser.add_argument("--amppred-root", default=os.environ.get("AMPPRED_ROOT", "external/AMPpred-MFA"))
    parser.add_argument("--iamp-root", default=os.environ.get("IAMP_ROOT", "external/iAMP-Attenpred"))
    parser.add_argument("--unidl-root", default=os.environ.get("UNIDL_ROOT", "external/UniDL4BioPep"))
